...
// Подписи короткие намеренно: это лейблы в узкой колонке рядом с цифрой, а не
// предложения. Длинные формулировки на 320px ломались на три строки.
const stats = [
  { value: '24 часа', label: 'после твоего «да»', accent: false },
  { value: 'от 1 шт', label: 'одну тоже печатаем', accent: true },
  { value: '50+ стирок', label: 'принт не линяет', accent: false },
];
